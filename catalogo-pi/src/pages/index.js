...
export default function Home() {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="#">
      <Image alt="Foto" src={"/assets/logo.png"} width={150} height={60}/>
    </a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="row">
        {
          listaProduto.map((dado,index) => <Produto key={index} nome={dado.nome} descricao={dado.descricao} 
                disponivel={dado.disponivel} novidade={dado.novidade} preco={dado.preco}/>)
        }
      </div>
    </>
  );
